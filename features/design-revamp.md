...
| B3.1–B3.4 | `data/expansion-<n>` | ~80 new dishes, ~20 per batch, pool-report-driven | 2.2, B1 flowing | everything | in progress (batch 1 `data/expansion-0`; batch 2 `data/expansion-1`, international) |
